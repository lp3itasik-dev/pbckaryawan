...
<body>
									...
									<table class="table table-framed" id="datatable-basic">
										<thead class="bg-lp3i-dark">
											<tr>
												...
												<th width="100px" class="text-center">NIK/NIDN</th>
										...
										<tbody>
										    ...
										    foreach($read as $r){
													...
													<tr>
														...
														<td width="100px" class="text-center">'.$r->nik.'</td>
														...
														<td width="50px" class="text-center">
															...
															<a class="btn bg-lp3i" href="'.base_url().'adm/cetak_loc/'.$r->id.'" target="_blank">CETAK</a>
														</td>
													</tr>
													';
												}
	...
	<script>
        ...
        function hapus(id,nama){
          ...
          $('#formId').attr('action', '<?= base_url() ?>Adm/delete_prodi/'+id);
        }
	</script>
